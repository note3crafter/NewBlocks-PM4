...
namespace TheNote\NewBlocks\entity\projectile;
...
use TheNote\NewBlocks\items\Trident as TridentItem;
use TheNote\NewBlocks\sounds\TridentHitGroundSound;
use TheNote\NewBlocks\sounds\TridentHitSound;
...
class ThrownTrident extends Projectile {
    ...
    protected function onHitEntity(Entity $entityHit, RayTraceResult $hitResult): void
    {
        ...
        if ($entityHit->getId() === $this->ownerId) {
            if ($entityHit instanceof \pocketmine\player\Player) {
