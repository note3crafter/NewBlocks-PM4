...
use TheNote\NewBlocks\events\EntityShootCrossbowEvent;
use TheNote\NewBlocks\Main;
use TheNote\NewBlocks\sounds\CrossbowLoadingEndSound;
use TheNote\NewBlocks\sounds\CrossbowLoadingStartSound;
use TheNote\NewBlocks\sounds\CrossbowShootSound;
use function cos;
...
final class Crossbow extends Tool{
    ...
    public function onClickAir(Player $player, Vector3 $directionVector) : ItemUseResult{
        ...
        if(!$this->isCharged()){
            ...
            Main::$crossbowLoadData[$player->getName()] = true;
        }else{
    ...
    public function onReleaseUsing(Player $player) : ItemUseResult{
        unset(Main::$crossbowLoadData[$player->getName()]);
