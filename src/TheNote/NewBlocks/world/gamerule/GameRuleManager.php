...
namespace TheNote\NewBlocks\world\gamerule;

use TheNote\NewBlocks\world\gamerule\types\DoDayLightCycleRule;
use TheNote\NewBlocks\world\gamerule\types\DoWeatherCycleRule;
use pocketmine\nbt\tag\ByteTag;
use pocketmine\nbt\tag\CompoundTag;
use pocketmine\nbt\tag\IntTag;
use pocketmine\nbt\tag\Tag;
