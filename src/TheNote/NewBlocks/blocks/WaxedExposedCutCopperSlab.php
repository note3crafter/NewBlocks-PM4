...
class WaxedExposedCutCopperSlab extends Slab
{
    public function __construct(BlockIdentifier $idInfo, ?BlockBreakInfo $breakInfo = null)
    {
        parent::__construct($idInfo, "Waxed Exposed Cut Copper Slab", $breakInfo ?? new BlockBreakInfo(3, BlockToolType::PICKAXE));
    }
