...
use TheNote\NewBlocks\sounds\ItemFrameAddItemSound;
use TheNote\NewBlocks\tiles\Campfire as CampfireTile;
...
class Campfire extends Transparent
{
    ...
    public function onInteract(Item $item, int $face, Vector3 $clickVector, ?Player $player = null): bool
    {
        if ($player !== null) {
            ...
            if ($tile instanceof CampfireTile && $tile->addItem(clone $item)) {
                $item->pop();
